 ...
 if(!isset($_SESSION['stuLogEmail'])) {
  ...
  <div class="container mt-5">
    ...
    <form method="post" action="./paymentdone.php" id="myform">
     ...
     <small class="form-text text-muted">Note: Complete Payment by Clicking Checkout </small>
     <!-- Google Form Link Option -->
     <p>
                     <a href="https://surl.li/oatnx" target="submit">Checkout</a> to fill out our Google Form.
                </p>
            </div>
        </div>
    </div>
